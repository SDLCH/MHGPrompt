...
def build_args():
    parser = argparse.ArgumentParser(description="HGMAE+HeCo")
    ...
    parser.add_argument("--feat_mask_rate", type=str, default="0.5,0.005,0.8",
                        ...
                        If Provide '0.5,-0.1,0.7', mask rate starts from 0.5, ends at 0.7 and add 0.1 for each epoch.""")
    ...
    parser.add_argument('--patience', type=int,
                        default=50)  # 5. we can change the value. this might impact the performance.
    parser.add_argument('--l2_coef', type=float, default=0)

    # The parameters of metapath2vec
    parser.add_argument("--use_mp2vec_feat_pred", action="store_true", default=True,
    ...
    # read config
    parser.add_argument("--use_cfg", action="store_true", default=True, help="Set to True to read config file")
    ...
    parser.add_argument('--mae_epochs', type=int, default=1000)
    ...
    parser.add_argument('--heco_loss_weight', type=float)
    parser.add_argument("--p_num", type=int, default=40)
